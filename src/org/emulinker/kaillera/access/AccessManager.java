...
public interface AccessManager
{
	...
	public static int		ACCESS_COOWNER		= 6;
	public static int		ACCESS_OWNER		= 7;

	public static String[]	ACCESS_NAMES	= { "Banned", "Normal", "Elevated", "Moderator", "Admin", "Super Admin", "Server Co-Owner", "Server Owner"};
